...
if __name__ == '__main__':
    iteration, length, pencolor, backgroundcolor, printans = (
        int(input('Enter number of iterations:') or 9),  # input of pen color
        int(input('Enter lenght of each segment:') or 10),
        str(input('Enter pen color:') or 'red'),
        str(input('Enter background color:') or 'black'),  # and bg color
